        ...
        children: [
          ...
          _buildSettingsGroup(
            children: [
              _buildSwitchTile(
                ...
                onChanged: (val) => setState(() => _pushAnnouncements = val),
              ),
              const Divider(height: 1),
              _buildSwitchTile(
                title: 'Borç ve Aidat Hatırlatmaları',
                subtitle: 'Yeni bir borç eklendiğinde veya son ödeme tarihi yaklaştığında',
                value: _pushDebts,
              ...
              _buildSwitchTile(
                ...
                subtitle: 'Oluşturduğunuz taleplerin durumu değiştiğinde (örn: Çözüldü)',
                value: _pushMaintenance,
                onChanged: (val) => setState(() => _pushMaintenance = val),
              ),
            ],
          ),
          ...
          _buildSettingsGroup(
            children: [
              ...
              _buildSwitchTile(
                title: 'SMS Uyarıları',
                subtitle: 'Sadece çok acil durumlarda (Su kesintisi vb.) kısa mesaj',
                value: _smsAlerts,
            ...
            child: ElevatedButton(
              onPressed: () {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('Bildirim tercihleriniz başarıyla kaydedildi!')),
                );
  ...
  Widget _buildSwitchTile({
    ...
    return SwitchListTile(
      ...
      subtitle: Padding(
        ...
        child: Text(subtitle, style: AppTextStyles.labelSmall.copyWith(color: AppColors.textSecondary)),
      ),
